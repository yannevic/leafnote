...
const CHANGELOG: Record<string, string[]> = {
  ...
  '3.0.74': [
    ...
    "💌 Muralzinho de recados no perfil — deixem mensagens um pro outro",
    "🕺 Bonequinho do perfil agora pode ser arrastado pra onde quiser",
    "🎨 Decoração do perfil: coloquem stickers, molduras e fundos do jeito que quiserem",
    "🖼️ Molduras de badge: uma vitrine pra exibir suas conquistas de coleção",
    "🌈 Fundos personalizáveis pro perfil, com opções grátis e compráveis",
    "🏅 Badges das coleções ganharam artes novas, em formato de moedinha dourada",
    "🔄 Moldura de badge ficou mais fácil de usar: agora dá pra trocar ou remover badges direto num menu",
    "📜 Extrato de moedas mais claro, mostrando o nome certinho de cada compra",
    "☁️ Nova Coleção de Cartas Especial: tema Clima e Fenômenos!",
    "🎁 Completar uma coleção agora dá recompensa: insígnia, moedas, mini-pacote e uma carta especial",
    "✨ Nova telinha de resgate de recompensas, com revelação animada da carta especial",
    "📚 Coleção de Cartas Especial aparece direto na aba de coleção, junto com as outras",
    "📂 Categorias da coleção começam fechadas — abram a que quiserem ver",
    "💰 Agora dá pra vender carta especial repetida pra Folhinha",
    "🧺 Tela de vender pra Folhinha reorganizada e mais bonita",
    "🛍️ Agora dá pra vender ou negociar várias cartas diferentes de uma vez",
    "🤝 Visual da troca pendente com o parceiro ficou mais bonito e organizado",
    "💫 Corrigido o brilho de cartas raras e épicas — agora ele brilha sem parar, do jeito certo",
  ],
